...
VALUES
    ('Rapid Port Scan', '10+ unique ports accessed within 1 second', 'UNIQUE_DEST_PORTS', TRUE, 10, 1),
    ('Large Data Transfer', 'Detects any packet over 10000 bytes', 'LARGE_PACKET', TRUE, 10000, 1),
    ('Restricted Port Access', 'Detects traffic to ports like 23 (Telnet), 3389 (RDP)', 'RESTRICTED_PORTS', TRUE, 1, 1);
